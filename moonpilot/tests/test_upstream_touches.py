...
ALLOWED = {
  ...
  "openpilot/selfdrive/selfdrived/selfdrived.py": "lateral engagement events and panda cross-check, the fork's startup alert, and the turn-desire banner",
  "openpilot/selfdrive/selfdrived/events.py": "the half-engagement banner; the turn-desire banner",
