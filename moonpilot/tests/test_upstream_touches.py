...
ALLOWED = {
  ...
  "openpilot/cereal/log.capnp": "moonpilotState event field; the PandaState lateral-controls field; the fork's EventName values",
  ...
  "openpilot/selfdrive/selfdrived/selfdrived.py": "lateral engagement, panda cross-check, startup alert, turn-desire and path-outside banners",
  "openpilot/selfdrive/selfdrived/events.py": "the half-engagement banner; the turn-desire banner; the path-outside banner",
  ...
  "openpilot/selfdrive/ui/mici/onroad/alert_renderer.py": "turn-desire banner icon and height",
